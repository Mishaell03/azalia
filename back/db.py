...
def add_sample_data():
    ...
    ''', [ 
        ...
        ('Эчеверия', 'Красивый суккулент с розеткой мясистых листьев', 650.00, 3, 2, 'succulent', 'S', 15, 'Минимальный полив, много света', 'full_sun', '1 раз в 2 недели', 4.8, True, 'img/1.png',4),
        ('Колючая ', 'Кактус с плоскими стеблями и колючками', 750.00, 3, 2, 'cactus', 'M', 25, 'Редкий полив, прямые солнечные лучи', 'full_sun', '1 раз в 3 недели', 4.3, True, 'img/2.png',5),
        ('Сансевиерия', 'Неприхотливый суккулент с длинными вертикальными листьями', 500.00, 3, 2, 'succulent', 'S', 30, 'Умеренный полив, переносит тень', 'shade', '1 раз в 2 недели', 4.9, True, 'img/3.png',10),
        # Фикусы (category_id=4)
        ('Кудрявый фикус Барок', 'Кудрявый невысокий фикус с красивыми листьями', 1200.00, 1, 4, 'foliage', 'M', 35, 'Регулярный полив, опрыскивание', 'partial_shade', '1 раз в неделю', 4.7, True, 'img/4.png',5),
        ('Фикус Бенджамина Вариегата', 'Фикус с белым обрамлением листочков', 1500.00, 1, 4, 'foliage', 'M', 45, 'Регулярный полив, избегать сквозняков', 'partial_shade', '1 раз в неделю', 4.9, True, 'img/5.png',9),
        ('Фикус Natasja', 'Засухоустойчивый фикус', 1100.00, 1, 4, 'foliage', 'S', 25, 'Умеренный полив', 'partial_shade', '1 раз в 10 дней', 4.5, True, 'img/6.png',1),
        
        # Цветущие растения (category_id=1)
        ('Фиалка Коршунова', 'Комнатное травенистое растение', 550.00, 1, 1, 'flowering', 'S', 12, 'Полив в поддон, избегать попадания воды на листья', 'partial_shade', '2-3 раза в неделю', 4.8, True, 'img/7.png',3),
        ('Азалия Вервениана', 'Сильно ветвистое цветущее растение', 1800.00, 2, 1, 'flowering', 'M', 40, 'Регулярный полив, подкормка во время цветения', 'partial_shade', '2 раза в неделю', 4.6, True, 'img/8.png',15),
        ('Бегония Элатиор Кармен', 'Многолетнее растение с большим количеством листьев', 850.00, 1, 1, 'flowering', 'S', 18, 'Регулярный полив, опрыскивание', 'shade', '2 раза в неделю', 4.4, True, 'img/9.png',5),
        
        # Хвойные растения (category_id=3)
        ('Сосна горная', 'Пышная сосна с колючими веточками', 2200.00, 3, 3, 'foliage', 'L', 60, 'Редкий полив, много свежего воздуха', 'full_sun', '1 раз в 2 недели', 4.9, True, 'img/10.png',6),
        ('Китайская ель Коника', 'Высокая ель с конусовидной формой, выведенная искусственно', 2800.00, 3, 3, 'foliage', 'L', 70, 'Умеренный полив, защита от прямого солнца', 'partial_shade', '1 раз в неделю', 4.7, True, 'img/11.png',4),
        ('Туя', 'Медленнорастущая с компактной кроной ель с мягкими колючками', 1900.00, 3, 3, 'foliage', 'M', 50, 'Регулярный полив, опрыскивание', 'full_sun', '1 раз в неделю', 4.5, True, 'img/12.png',4)
    ])
    ...
    cursor.executemany('''
        ...
        VALUES (?, ?, ?)
    ''', [
        (123456789, 'Анна', '+79161234567'),
        (987654321, 'Иван', '+79167654321'),
        (555555555, 'Мария', '+79165554433'),
        # Работники тоже являются пользователями
        (111111111, 'Ольга', '+79161112233'),
        (5287879603, 'Михаил', '+79507045044'),
        (222222222, 'Дмитрий', '+79162223344'),
        (333333333, 'Екатерина', '+79163334455')
    ])
    ...
    ''', [
        ...
        (5287879603, 4, 2000000.00),  # Михаил (Я :3 ) - администратор
